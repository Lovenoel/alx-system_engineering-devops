...
def count_words(subreddit, word_list, hot_list=[], after=None, counts={}):
    """Recursively queries the Reddit API, parses the titles of hot articles, and counts given keywords."""
    ...
    # Sort the counts dictionary by count descending and then by word alphabetically
